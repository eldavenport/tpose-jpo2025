...
def tpose2012to2016(prefix):
    ...
    for month in folder_months:
        ...
        new = open_mdsdataset(data_dir=data_dir,grid_dir=grid_dir,iters=intervals,prefix=prefix)
